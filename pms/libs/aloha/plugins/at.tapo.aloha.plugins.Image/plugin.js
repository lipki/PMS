...
var TAPO = function(){
	...
	jQuery("head link:last").after('<link rel="stylesheet" type="text/css" href="' + GENTICS.Aloha.settings.base + 'plugins/at.tapo.aloha.plugins.Image/resources/imageplugin.css">');
